...
const getToken = async(code) => {
    ...
    const response = await fetch(
        "https://7qlb9t2yhg.execute-api.eu-central-1.amazonaws.com/dev/api/token" + "/" + encodeCode
    );
...
export const getEvents = async () => {
    ...
    if (token) {
        removeQuery();
        const url = "https://7qlb9t2yhg.execute-api.eu-central-1.amazonaws.com/dev/api/get-events" + "/" + token;
